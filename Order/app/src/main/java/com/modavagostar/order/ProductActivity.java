...
import com.modavagostar.order.model.ListAdapter;
...
public class ProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialize adapter
        listAdapter = new ListAdapter(ProductActivity.this, listUnitList);
        share = new SharedpreferenceHelper(ProductActivity.this);
        ...
        String hh = String.valueOf(getIntent().getSerializableExtra("brandname"));
        Button z = (Button) findViewById(R.id.titlesub2);
        z.setText(hh);
        pListURL = "http://185.172.68.32:8096/v1/product/getAllProduct?page=";
...
// Changing action button text color
                ...
                if ((error instanceof ServerError) || (error instanceof AuthFailureError)) {
                    ...
                    SharedpreferenceHelper sessionManager = new SharedpreferenceHelper(ProductActivity.this);
...
//         Log.e("Body",new String(jsonObjReq.getBody(), "UTF-8"));
    ...
    public void parseJson4(JSONArray response) {
        ...
        SharedpreferenceHelper session = new SharedpreferenceHelper(ProductActivity.this);
...
//        Toast.makeText(getApplicationContext(),urlLogin, Toast.LENGTH_SHORT).show();
        ...
        try {
            int h = Integer.parseInt(String.valueOf(getIntent().getSerializableExtra("brandid")));
...
//                listUnit.setInStockNumber(inStockNumber);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_home) {
            ...
            Intent myIntent = new Intent(ProductActivity.this,
                    MainActivity.class);
